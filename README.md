...
> - [yamibo-app](https://github.com/LittleSurvival/yamibo-app) by [@LittleSurvival](https://github.com/LittleSurvival)（支持多平台，但暂无 iOS 版）
> - [Pocket300](https://github.com/TnZzZHlp/Pocket300) by [@TnZzZHlp](https://github.com/TnZzZHlp)
> - [300X](https://github.com/belleangelina/300X) by [@belleangelina](https://github.com/belleangelina)（支持多平台，但暂无 iOS 版）
> - [y300](https://github.com/QAQadws/y300) by [@QAQadws](https://github.com/QAQadws)（支持多平台，但暂无 iOS 版）
>
> **iOS**
...
3. 小说横/竖屏切换或简繁转换时，可能会有大幅度的页面偏移，但应该没人经常换这东西<img width="32" height="32" alt="2c4f40113caa2a4fbe3f5f9905492883" src="https://github.com/user-attachments/assets/1b867a2b-1f56-400e-8a15-341664b749d0" />。
...
- 收藏分类：点击收藏夹链接时，会自动在后台判断目标类别，并重定向，同时支持分类查看。
- 书签、目录和缓存管理：可通过收藏页面管理书签、目录和缓存。
- 搜索：可按收藏标题搜索过滤。
- 自动更新检查：后台自动检查收藏的小说/漫画是否有更新，支持配置检查策略与间隔。
- 侧滑手动检查：收藏项左滑可触发更新检查。右滑可触发更新配置。

4. 论坛浏览强化

- 夜间模式：论坛页面支持深色主题。
- 长按底栏快捷操作：长按底栏图标弹出功能球 返回首页、切换夜间模式（继续上滑可切换主题）、刷新 。
- 后台自动签到：自动在后台完成每日签到。
